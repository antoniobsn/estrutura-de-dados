...
public class ListaDuplamenteEncadeada {
	...
	private static void removeDaLista(Scanner entrada) {
		...
		if (inicio == null) {
			...
			System.out.print("\nDigite o Codigo Numerico a ser removido: ");
			...
			if (achou == 0) {
				System.out.println("Codigo Numerico nao encontrado");
			} else if (achou == 1) {
				System.out.println("Codigo Numerico removido 1 vez");
			} else {
				System.out.println("Codigo Numerico removido " + achou + " vezes");
			}
		}
	}
	...
	private static void insereFimLista(Scanner entrada) {
		System.out.println("Digite o Codigo Numerico a ser inserido no fim da lista: ");
		...
		System.out.println("Codigo Numerico inserido no fim da lista!!");
	}

	private static void inserInicioLista(Scanner entrada) {
		System.out.println("Digite o Codigo Numerico a ser inserido no inicio da lista");
		...
		System.out.println("Codigo Numerico inserido no inicio da lista!!");
	}
